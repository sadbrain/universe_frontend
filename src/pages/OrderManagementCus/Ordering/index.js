...
function Ordering() {
   ...
   return Object.values(orderings).map((ordering) => (
      <div className="row" key={ordering.id}>
         <div className="col-1"></div>
         <div className="col-10 custom-border mb-5">
            {ordering.order_details.map((orderDetail, index) => (
            ...
            <div className="row maincontent-size">
               ...
               <div className="col-5">
                  ...
                  <div className="row flex-item mt-2">
                     ...
                     <p className="col-1"></p>
                     <p className="col-5 btn rounded-15 btn-success font-weight-bold maincontent-size ml-2">Pay now</p>
                  </div>
               </div>
            </div>
         </div>
